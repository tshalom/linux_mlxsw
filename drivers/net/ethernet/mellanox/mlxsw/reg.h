...
static inline void mlxsw_reg_mtpptr_pack(char *payload,
					 u8 local_port,
					 enum mlxsw_reg_mtpptr_dir dir)
{
	MLXSW_REG_ZERO(mtpptr, payload);
	mlxsw_reg_mtpptr_local_port_set(payload, local_port);
	mlxsw_reg_mtpptr_dir_set(payload, dir);
	mlxsw_reg_mtpptr_clr_set(payload, 1);
}
